                ...
                <tr>
                  <td class="td_left">
                    <div class="editor_area btn-editor" style="width:100%">
                      ...
                      <div class="editor_area btn-editor" style="width:100%">
                        <input type="hidden" name="terms_management_idx" id="terms_management_idx" value="<?=$result->terms_management_idx?>">
                      <textarea class="input-block-level" id = "contents_kr" name="contents_kr"><?=$result->contents_kr?></textarea>

                      <div class="editor_area btn-editor" style="width:100%">
                        <input type="hidden" name="terms_management_idx" id="terms_management_idx" value="<?=$result->terms_management_idx?>">
                        <textarea class="input-block-level" id = "contents_us" name="contents_us"><?=$result->contents_us?></textarea>

                        <div class="editor_area btn-editor" style="width:100%">
                          <input type="hidden" name="terms_management_idx" id="terms_management_idx" value="<?=$result->terms_management_idx?>">
                        <textarea class="input-block-level" id = "contents_bd" name="contents_bd"><?=$result->contents_bd?></textarea>
