              ...
              <tr>
                ...
                <td colspan="3">
                  <!-- <input name="memo" id="memo" type="text" class="form-control" maxlength="100"> -->
                    <input name="memo_kr" id="memo_kr" type="text" class="form-control" maxlength="100">
                    <input name="memo_us" id="memo_us" type="text" class="form-control" maxlength="100">
                    <input name="memo_bd" id="memo_bd" type="text" class="form-control" maxlength="100">
                </td>
              </tr>
