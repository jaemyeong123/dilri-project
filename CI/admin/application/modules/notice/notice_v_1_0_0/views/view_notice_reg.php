        ...
        <form name="form_default" id="form_default" method="post">
            ...
            <colgroup>
          	...
          	<col style="width:35%">
        		...
        		<tbody>
              <tr>
                <th> <span class="text-danger">*</span>  제목 <br> </th>
                <td colspan="3">
                  <!-- <input name="title" id="title" type="text" class="form-control" style="width:100%">-->
                  <input name="title_us" id="title_us" type="text" class="form-control" style="width:100%">
                  <input name="title_kr" id="title_kr" type="text" class="form-control" style="width:100%">
                  <input name="title_bd" id="title_bd" type="text" class="form-control" style="width:100%">
                </td>
              </tr>
              <tr>
                <th>
              ...
              <tr>
                <td colspan="4" class="table_left" colspan="3">
                  ...
                  <textarea class="input_default textarea_box" name="contents_us" id="contents_us" placeholder="내용(영어)"></textarea>
                  <textarea class="input_default textarea_box" name="contents_kr" id="contents_kr" placeholder="내용(한국어)"></textarea>
                  <textarea class="input_default textarea_box" name="contents_bd" id="contents_bd" placeholder="내용(뱅골어)"></textarea>
                </td>
              </tr>
              <tr>
               <th>노출 여부</th>
