...
class MY_Controller extends CI_Controller {
	...
	//	$this->admin_lang=$this->session->userdata('admin_lang');
     ...
     $data['device_os'] = $row->device_os;
       ...
       switch ($index) {
         ...
         case '109' : $msg ="নোটিফিকেশনঃ বুকিং বাতিল হয়েছে।";$data['product_idx']=$alarm_data['product_idx']; break;
				 case '113' : $msg ="প্রশাসকের দ্বারা নিবন্ধিত ব্যবহৃত লেনদেন নিবন্ধটি অন্ধভাবে প্রক্রিয়া করা হয়েছে৷";$data['product_idx']=$alarm_data['product_idx']; break;
         case '114' : $msg ="প্রশাসক দ্বারা নিবন্ধিত পোস্ট অন্ধ করা হয়েছে";$data['board_idx']=$alarm_data['board_idx']; break;
       }
     } else {
       switch ($index) {
         ...
         case '109' : $msg ="Notification, Booking cancled";$data['product_idx']=$alarm_data['product_idx']; break;
				 case '113' : $msg ="The used transaction article registered by the administrator has been processed blindly";$data['product_idx']=$alarm_data['product_idx']; break;
         case '114' : $msg ="Posts registered by the administrator have been blinded";$data['board_idx']=$alarm_data['board_idx']; break;
       }
     }
