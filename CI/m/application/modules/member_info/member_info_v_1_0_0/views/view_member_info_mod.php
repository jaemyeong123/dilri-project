...
<div class="modal_photo_reg" >
  <ul class="more_ul">
    <li>
      <a href="javascript:void(0)" onclick="api_request_file_upload('member_img');modal_close_slide('photo_reg');"><?=lang("lang_member_info_00839","앨범에서 사진 선택")?></a>
    </li>
    <li>
      <a href="javascript:void(0)" onclick="set_one_img('');modal_close_slide('photo_reg');"><?=lang("lang_member_info_00840","기본 이미지로 변경")?></a>
    </li>
    <li class="close">
...
alert("<?=lang("lang_join_00836","발송 중입니다. 잠시만 기다려주세요.")?>");
