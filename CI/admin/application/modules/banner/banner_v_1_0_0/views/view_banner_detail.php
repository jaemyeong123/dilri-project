...
<script>
  ...
  function default_mod(){
    ...
    $.ajax({
      ...
      success  : function(result){
        ...
        // 0:실패 1:성공
        if(result.code == 0) {
          alert("Edit  failed."); //수정이 실패하였습니다.
        } else {
          alert("It's been Edit ed"); //수정되었습니다.
          default_list();
        }
      }
    });
  ...
  function banner_del(banner_idx){
		...
		if(!confirm("Are you sure you want to delete it?"))//삭제하시겠습니까?
		{
    return;
  	}
    ...
    $.ajax({
      ...
      success: function(result) {
        ...
        // 0:실패 1:성공
        if(result.code == 0) {
          alert("Deletion failed.");//삭제가 실패하였습니다.
        } else {
          alert("Deleted.");//삭제되었습니다.
          default_list();
        }
      }
    });
