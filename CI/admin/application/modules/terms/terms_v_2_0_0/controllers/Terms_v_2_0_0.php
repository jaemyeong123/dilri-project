...
//		$contents = $this->_input_check("contents",array("empty_msg"=>"내용을 입력해주세요."));
		$contents_kr = $this->_input_check("contents_kr",array("empty_msg"=>"내용을 입력해주세요."));
		$contents_us = $this->_input_check("contents_us",array("empty_msg"=>"내용을 입력해주세요."));
		$contents_bd = $this->_input_check("contents_bd",array("empty_msg"=>"내용을 입력해주세요."));
	//	$contents= $this->input->post("contents");

			$contents_kr= $this->input->post("contents_kr");
				$contents_us= $this->input->post("contents_us");
					$contents_bd= $this->input->post("contents_bd");
