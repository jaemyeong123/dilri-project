...
<div class="body vh_wrap">
  <div class="vh_body" style="padding-bottom:90px;">
    <div class="inner_wrap">
      ...
      <input type="tel" pattern="\d*"/ id="member_phone" name="member_phone"
      <? if($this->current_nation=='kr'){ ?>
      placeholder="'-' 를 제외한 숫자만 입력해 주세요."
      <? } else if($this->current_nation=='us'){?>
        placeholder="Please enter only numbers except '-'"
      <? } else {?>
        placeholder="অনুগ্রহ করে শুধুমাত্র '-' ব্যতীত সংখ্যা লিখুন।"
      <? } ?>
 >
