      ...
      <a href="javascript:void(0)"><?=lang("lang_mypage_00646","알림")?>
		...
		<li class="lang">
			...
			<select class="lang_slt" name=""  onchange="do_view_type(this.value)">
				...
				<option value="bd" <?php if($this->uri->segment(1)=="bd"){ echo "selected";}?> >বাংলা</option>
				<option value="us" <?php if($this->uri->segment(1)=="us"){ echo "selected";}?> >English</option>
				<option value="kr" <?php if($this->uri->segment(1)=="kr"){ echo "selected";}?> >한국어</option>
