...
class Chatting_v_1_0_0 extends MY_Controller{
  ...
  // 등록
    ...
    $response = new stdClass();
		...
		$member_idx = $this->_input_check('user_idx',array("empty_msg"=>lang("lang_chatting_00840","채팅 맴버가 존재하지 않습니다."),"focus_id"=>"user_idx"));
		$chatting_room_idx = $this->_input_check('chatting_room_idx',array("empty_msg"=>lang("lang_chatting_00841","채팅방이 존재하지 않습니다."),"focus_id"=>"chatting_room_idx"));
