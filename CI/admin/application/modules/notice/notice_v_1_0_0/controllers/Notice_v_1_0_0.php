...
class Notice_v_1_0_0 extends MY_Controller{
	...
	//	$title = $this->_input_check("title",array("empty_msg"=>"제목을 입력해 주세요."));
		$title_us = $this->_input_check("title_us",array("empty_msg"=>"제목을 입력해 주세요."));
		$title_kr = $this->_input_check("title_kr",array("empty_msg"=>"제목을 입력해 주세요."));
		$title_bd = $this->_input_check("title_bd",array("empty_msg"=>"제목을 입력해 주세요."));
		// $contents = $this->_input_check("contents",array("empty_msg"=>"내용을 입력해 주세요."));
		$contents_us = $this->_input_check("contents_us",array("empty_msg"=>"내용을 입력해 주세요."));
		$contents_kr = $this->_input_check("contents_kr",array("empty_msg"=>"내용을 입력해 주세요."));
		$contents_bd = $this->_input_check("contents_bd",array("empty_msg"=>"내용을 입력해 주세요."));
