        ...
        <div class="table-responsive">
          ...
          <div class="row category_col">
            ...
            <div class="col-md-3">
              ...
              <h4>Category 2</h4>
              <input type="text" class="form-control add_item_val" placeholder="카테고리 2차명"> <a href="#" class="btn btn-info" onclick="category_management_reg_in(1)"> Add</a>
            </div>
            <div class="col-md-3">
              <h4>Category 3</h4>
              <ul class="category sortable" style="height:500px">
              ...
              <h4>Category 3</h4>
              <input type="text" class="form-control add_item_val" placeholder="카테고리 3차명"> <a href="#" class="btn btn-info" onclick="category_management_reg_in(2)"> Add</a>
            </div>
            <div class="col-md-3">
              <h4>Category 4</h4>
              <ul class="category sortable" style="height:500px">
              ...
              <h4>Category 4</h4>
              <input type="text" class="form-control add_item_val" placeholder="카테고리 4차명"> <a href="#" class="btn btn-info" onclick="category_management_reg_in(3)"> Add</a>
            </div>
          </div>
