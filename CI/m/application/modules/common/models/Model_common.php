...
Class Model_common extends MY_Model {
	...
	public function member_point_mod_up($data){
		...
		// }elseif ($memo_type=='2' && $total_point<360) {
			...
			$memo = "프로필 사진 최초 등록";
			$memo_kr = "프로필 사진 최초 등록";
			$memo_us = "Register profile picture for the first time";
			$memo_bd = "প্রথমবারের জন্য প্রোফাইল ছবি নিবন্ধন করুন";
			$point_add_yn = 'Y';
		}elseif ($memo_type=='3' && $total_point<360) {
			$memo = "커뮤니티 글쓰기 1회";
			$memo_kr = "커뮤니티 글쓰기 1회";
			$memo_us = "Community writing once";
			$memo_bd = "সম্প্রদায় লেখা একবার";
			$sql = "SELECT
								count(*) as cnt
							FROM
								tbl_member_point a
			...
			$memo = "커뮤니티 스크랩 1회";
			$memo_kr = "커뮤니티 스크랩 1회";
			$memo_us = "Community scrap once";
			$memo_bd = "কমিউনিটি স্ক্র্যাপ একবার";
			$sql = "SELECT
								count(*) as cnt
							FROM
								tbl_member_point a
			...
			$memo = "커뮤니티 추천 1회";
			$memo_kr = "커뮤니티 추천 1회";
			$memo_us = "One community recommendation";
			$memo_bd = "একটি সম্প্রদায় সুপারিশ";
			$sql = "SELECT
								count(*) as cnt
							FROM
								tbl_member_point a
		...
		if ($point_add_yn == 'Y') {
			...
			$data['title']=$title= '';
			$data['msg']=$msg= lang("lang_add_plus_00004","지급되었습니다.");
			$data["index"] ="111";
