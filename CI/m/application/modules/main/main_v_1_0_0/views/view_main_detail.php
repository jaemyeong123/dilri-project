...
switch ($this->nationcode)
 {
	case 'us':
			$row->category_name = $row->category_name_us;
		break;
		case 'kr':
				$row->category_name = $row->category_name_kr;
			break;
			case 'bd':
				$row->category_name = $row->category_name_bd;
				break;
}
				?>
				<li >
	...
	<?
	 if(!empty($notice)){
		 switch ($this->nationcode)
		  {
		 	case 'us':
		 			$notice->title = $notice->title_us;
		 		break;
		 		case 'kr':
		 				$notice->title = $notice->title_kr;
		 			break;
		 			case 'bd':
		 				$notice->title = $notice->title_bd;
		 				break;
		 }
	?>
