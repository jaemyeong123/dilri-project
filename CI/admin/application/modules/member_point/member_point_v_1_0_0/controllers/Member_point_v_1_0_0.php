...
class Member_point_v_1_0_0 extends MY_Controller{
	...
	public function member_point_reg_in(){
		...
		$memo_kr = $this->_input_check("memo_kr",array());
		$memo_us = $this->_input_check("memo_us",array());
		$memo_bd = $this->_input_check("memo_bd",array());

		$data['member_idx'] = $member_idx;
		$data['memo'] = $memo;

		$data['memo_kr'] = $memo_kr;
		$data['memo_us'] = $memo_us;
		$data['memo_bd'] = $memo_bd;
