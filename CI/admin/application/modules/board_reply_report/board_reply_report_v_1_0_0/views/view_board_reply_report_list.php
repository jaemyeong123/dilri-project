...
<div class="container-fluid  wide">
  ...
  <div class="page-header">
    <h1>Community comment/response reporting management</h1>
  </div>
      ...
      <table class="search_table">
        ...
        <tbody>
          <tr>
            ...
            <th style="text-align:center;">detail of Comments/Comments</th>
            <td>
          ...
          <tr>
            ...
            <td colspan="3">
              ...
              <label class="checkbox-inline"><input type="radio" name="report_type" value="2" > Others</label>
            </td>
          </tr>
        </tbody>
      </table>
