    ...
    <div class="bg_wh mt20">
      ...
      <div class="table-responsive">
        <table class="search_table">
          ...
          <tbody>
            <tr>
              <th style="text-align:center">Image<br><input type="button" class="btn btn-xs btn-default" id="file1" value="사진등록" onclick="file_upload_click('img','image','1',150);">
              </th>
              <td>
        ...
        <div class="text-right mt20">
          <a href="javascript:void(0);" onclick="img_cancel();" class="btn btn-gray">Cancellation</a>
          <a href="javascript:void(0);" onclick="img_change_mod_up();" class="btn btn-success">Save</a>
        </div>
      </div>
