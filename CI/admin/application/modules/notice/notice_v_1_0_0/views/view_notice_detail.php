      ...
      <section>
        <form name="form_default" id="form_default" method="post">
          <table class="table table-bordered td_left">
            ...
            <tbody>
              <tr>
                <th><span class="text-danger">*</span> 제목 <br> (영어/한국어/뱅골어)</th>
                <td colspan="3">
                  <!--  <input class="form-control" type="text" name="title" id="title" value="<?=$result->title?>"> -->
                  <input class="form-control" type="text" name="title_us" id="title_us" value="<?=$result->title_us?>">
                  <input class="form-control" type="text" name="title_kr" id="title_kr" value="<?=$result->title_kr?>">
                  <input class="form-control" type="text" name="title_bd" id="title_bd" value="<?=$result->title_bd?>">
                </td>
              </tr>
              <tr>
                <th>
              ...
              <tr>
                <th colspan="4">
                  <span class="text-danger">*</span> 내용 (영어/한국어/뱅골어)
                </th>
              </tr>
              <tr>
                <td colspan="4" class="table_left" colspan="3">
                  ...
                  <textarea class="input_default textarea_box" name="contents_us" id="contents_us" placeholder="내용(영어)"><?=$result->contents_us?></textarea>
                  <textarea class="input_default textarea_box" name="contents_kr" id="contents_kr" placeholder="내용(한국어)"><?=$result->contents_kr?></textarea>
                  <textarea class="input_default textarea_box" name="contents_bd" id="contents_bd" placeholder="내용(뱅골어)"><?=$result->contents_bd?></textarea>
                </td>
              </tr>
              <tr>
                <th>노출 여부</th>
